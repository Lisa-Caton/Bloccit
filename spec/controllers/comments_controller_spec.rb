...
RSpec.describe CommentsController, type: :controller do
  ...
  let(:my_comment) { Comment.create!(body: 'Comment Body', post: my_post, user: my_user) }
   ...
   # we create specs for member users who attempt to create new comments or delete comments they don't own. 
   # We will allow member users to create new comments,
   # but we'll redirect them to the posts show view if they try to delete another user's comment.
   ...
   # we test that members users are able to create new comments and delete their own comments.
   ...
   # we test that admin users are able to create and delete any comment, regardless of owner.
