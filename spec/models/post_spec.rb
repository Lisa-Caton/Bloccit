...
RSpec.describe Post, type: :model do
  #1 using the let method, we create a new instance of the Post class, and name it post
  ...
  # This tests whether post will return a non-nil value when post.title and post.body is called.
